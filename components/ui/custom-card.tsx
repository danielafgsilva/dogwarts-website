...
export interface CustomCardSubtitleProps extends React.HTMLAttributes<HTMLParagraphElement> {
  children: React.ReactNode
}
...
const CustomCardSubtitle = React.forwardRef<HTMLParagraphElement, CustomCardSubtitleProps>(
  ({ className, children, ...props }, ref) => (
